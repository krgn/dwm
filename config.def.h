...
static const Rule rules[] = {
	...
	{ "org.wezfurlong.wezterm",     "org.wezfurlong.wezterm", NULL,       1 << 2,				0,           -1 },
	{ "TelegramDesktop",				    "Telegram",       				NULL,       1 << 1,       0,           -1 },
	{ "Signal",									    "signal",       					NULL,       1 << 1,       0,           -1 },
	{ "Slack",									    "slack",       						NULL,       1 << 1,       0,           -1 },
	{ "Google-chrome", 							"google-chrome",       		NULL,       1,            0,           -1 },
	{ "Navigator", 									"firefox",       					NULL,       1,            0,           -1 },
};
...
static const char *darker[] = { "light", "-U", "10", NULL };
...
static Key keys[] = {
	...
	{ NULL,             						XF86XK_MonBrightnessUp,  	 spawn,		       {.v = brighter} },
	{ NULL,             						XF86XK_MonBrightnessDown,  spawn,		       {.v = darker} },
